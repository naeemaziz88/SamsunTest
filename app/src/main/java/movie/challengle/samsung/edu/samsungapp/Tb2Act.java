...
public class Tb2Act extends Activity {
    ...
    private class Asychn_parseData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Tb2Act.this);
        ...
        protected Void doInBackground(Void... arg0)
        {
            ...
            try {
                ...
                jsonStr = sh.makeServiceCall("http://api.themoviedb.org/3/movie/upcoming?api_key=810de7f88d6bf353b2a32d7541d180ff");
                if (jsonStr != null) {
                    try {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            MainActivity.col_change=1;
            //SHow Listview after parsing the jason data
            CustomBaseAdapter adapter = new CustomBaseAdapter(Tb2Act.this,MovieList);
